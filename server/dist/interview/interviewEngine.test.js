...
test("interview completes after eight answers and covers at least four days", () => {
    ...
    for (let index = 0; index < 8; index += 1) {
        latest = engine.answer("test-session", "I would identify the objective, inspect traces and metrics, compare retrieval or generation outputs, validate with tests, and then choose a production-safe fix with monitoring.");
    }
