...
export const MASTERY_ATTEMPT_BANDS = [
...
export class CandidateScoring {
    score(profile) {
        ...
        const overall = Math.round(completion * SCORE_WEIGHTS.completion +
...
export function recommendTopics(profile, limit = 4) {
