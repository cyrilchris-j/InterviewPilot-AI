import type { AnswerEvaluation, InterviewQuestion, PlanItem } from "../types/domain.js";
...
export class QuestionGenerator {
  generate(planItem: PlanItem, askedKeys: Set<string>, previousEvaluation?: AnswerEvaluation): InterviewQuestion {
