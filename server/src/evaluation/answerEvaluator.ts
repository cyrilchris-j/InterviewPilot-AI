import type { AnswerEvaluation, CandidateAnalysis, InterviewQuestion } from "../types/domain.js";
...
export class AnswerEvaluator {
  evaluate(question: InterviewQuestion, answer: string, analysis: CandidateAnalysis): AnswerEvaluation {
    ...
    const architectureThinking = clamp(
      Math.round(
        1 +
    ...
    const verdict: AnswerEvaluation["verdict"] = score >= 4 ? "strong" : score >= 2.8 ? "mixed" : "weak";
    const nextAction =
      verdict === "strong"
